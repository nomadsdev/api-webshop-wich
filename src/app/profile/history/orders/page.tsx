...
import { ArrowDownRight, Coins, Loader2, TrendingUp, User, ShoppingBag } from "lucide-react";
...
export default function OrdersHistoryPage() {
  ...
  const fetchOrdersHistory = async () => {
    try {
      setIsLoading(true);
      const response = await api.get("/otp/orders/history");
      ...
      <div className="min-h-screen p-3">
        <div className="max-w-5xl mx-auto space-y-3">
          <div className="text-center mb-5">
            <h1 className="text-xl">ประวัติการสั่งซื้อ</h1>
            <p className="text-muted-foreground text-sm">
              ดูประวัติการสั่งซื้อ OTP ทั้งหมดของคุณ
            </p>
          </div>
                ...
                <div className="text-center py-5">
                  <Empty>
                    <EmptyHeader>
                      ...
                      <EmptyDescription>ยังไม่มีประวัติการสั่งซื้อ</EmptyDescription>
                    </EmptyHeader>
                    <EmptyContent>
                      <Link href="/otp">
                        <Button className="cursor-pointer">
                            ซื้อ OTP <ArrowDownRight />
                        </Button>
                      </Link>
                    </EmptyContent>
                  </Empty>
